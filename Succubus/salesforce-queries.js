...
module.exports = {
     ...
     */
    allProjects: "Select Id, Target_Beneficiaries_Indirect__c, Target_Beneficiaries_Direct__c, Summary__c, Sub_Sector__c, Start_Date__c, Sector__c, Phase_Name__c, Name, Location__r.Admin_2__c, Location__r.Admin_1__c, Location__r.Admin_0__c, Location__c, ISD_Region__c, End_Date__c From Project__c",

    /**
     * Selects all of the fields from the organization (Account table).
     */
    allOrganizations: "Select Id, Name, Location__r.Admin_2__c, Location__r.Admin_1__c, Location__r.Admin_0__c, Location__c From Account",
