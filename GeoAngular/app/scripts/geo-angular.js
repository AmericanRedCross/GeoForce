...
//        }
        ...
        var printPostArgs = {
            ...
            url: $scope.routeUrl.href.replace("mapfolio/#", "mapfolio/print.html#").replace("/export", "").replace("http://localhost:3001", "https://geo.redcross.org"), //Swap the current url for the print url
