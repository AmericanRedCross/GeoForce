...
angular.module('GeoAngular').factory('Donuts', function () {
  ...
  /**
   * Code that is executed only once in the app goes here.
   */


  /**
   * Define Class Objects and prototypes here.
   */
  ...
  return {
      ...
      /* Make a lookup where we can get a color and label for a donut entity*/

      makeVisualizationDictionary : function(categoryEntities, opts){
     ...
     */
    ExpandoDonut: function(entities, visualizationDictionary, wrapper, labelPosition){
     ...
     */
    createLabelDonut: function(/*args*/) {
      /**
       * Instantiate object and return obj.
       */
    }
