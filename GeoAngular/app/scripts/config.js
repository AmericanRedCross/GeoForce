...
config.UNOCHAIconLookup = {
  ...
  "Grasshoppers": {icon: "icon-disaster_insect_infestation", color: "rgba(255,0,0," + config.UNOCHAOpacity + ")"},
  "Locusts": {icon: "icon-disaster_locust_infestation", color: "rgba(255,0,0," + config.UNOCHAOpacity + ")"},
  "Animal Attack": {icon: "icon-socioeconomic_livestock", color: "rgba(255,0,0," + config.UNOCHAOpacity + ")"},
  "Meteorite": {icon: "icon-damage_destroyed", color: "rgba(255,0,0," + config.UNOCHAOpacity + ")"},
  ...
  "Subsidence": {icon: "icon-disaster_earthquake", color: "rgba(255,0,0," + config.UNOCHAOpacity + ")"},
  ...
  "Famine / Food Insecurity": {icon: "icon-disaster_drought", color: "rgba(255,0,0," + config.UNOCHAOpacity + ")"},
  "Population Movement": {icon: "icon-crisis_population_displacement", color: "rgba(255,0,0," + config.UNOCHAOpacity + ")"},
  "Conflict": {icon: "icon-people_rebel", color: "rgba(255,0,0," + config.UNOCHAOpacity + ")"},
  "Terrorism": {icon: "icon-people_rebel", color: "rgba(255,0,0," + config.UNOCHAOpacity + ")"},
  ...
  "Meteorological - Local Storm": {icon: "icon-disaster_storm", color: "rgba(255,0,0," + config.UNOCHAOpacity + ")"},
  ...
  "Hydrological - Rockfall": {icon: "icon-disaster_landslide", color: "rgba(255,0,0," + config.UNOCHAOpacity + ")"},
  "Hydrological - Landslide": {icon: "icon-disaster_landslide", color: "rgba(255,0,0," + config.UNOCHAOpacity + ")"},
  "Hydrological - Avalanche": {icon: "icon-disaster_snow_avalanche", color: "rgba(255,0,0," + config.UNOCHAOpacity + ")"},
  "Hydrological - Subsidence": {icon: "icon-disaster_earthquake", color: "rgba(255,0,0," + config.UNOCHAOpacity + ")"},
  ...
  "Climatological - Extr Winter Conditions": {icon: "icon-disaster_cold_wave", color: "rgba(255,0,0," + config.UNOCHAOpacity + ")"},
  ...
  "Industrial - Chemical Spill": {icon: "icon-disaster_technological", color: "rgba(255,0,0," + config.UNOCHAOpacity + ")"},
  "Industrial - Collapse": {icon: "icon-damage_house_destroyed", color: "rgba(255,0,0," + config.UNOCHAOpacity + ")"},
  "Industrial - Explosion": {icon: "icon-disaster_fire", color: "rgba(255,0,0," + config.UNOCHAOpacity + ")"},
  "Industrial - Fire": {icon: "icon-disaster_fire", color: "rgba(255,0,0," + config.UNOCHAOpacity + ")"},
  "Industrial - Gas leak": {icon: "icon-security_dangerous_area", color: "rgba(255,0,0," + config.UNOCHAOpacity + ")"},
  "Industrial - Poisoning": {icon: "icon-security_dangerous_area", color: "rgba(255,0,0," + config.UNOCHAOpacity + ")"},
  "Industrial - Radiation": {icon: "icon-security_dangerous_area", color: "rgba(255,0,0," + config.UNOCHAOpacity + ")"},
  "Industrial - Other": {icon: "icon-other_cluster_other", color: "rgba(255,0,0," + config.UNOCHAOpacity + ")"},
  "Miscellaneous - Collapse": {icon: "icon-damage_house_destroyed", color: "rgba(255,0,0," + config.UNOCHAOpacity + ")"},
  "Miscellaneous - Explosion": {icon: "icon-disaster_fire", color: "rgba(255,0,0," + config.UNOCHAOpacity + ")"},
  "Miscellaneous - Fire": {icon: "icon-disaster_fire", color: "rgba(255,0,0," + config.UNOCHAOpacity + ")"},
  "Miscellaneous - Other": {icon: "icon-other_cluster_other", color: "rgba(255,0,0," + config.UNOCHAOpacity + ")"},
  "Transport - Air": {icon: "icon-logistics_airport", color: "rgba(255,0,0," + config.UNOCHAOpacity + ")"},
  "Transport - Rail": {icon: "icon-logistics_train", color: "rgba(255,0,0," + config.UNOCHAOpacity + ")"},
  "Transport - Road": {icon: "icon-logistics_road", color: "rgba(255,0,0," + config.UNOCHAOpacity + ")"},
  "Transport - Water": {icon: "icon-logistics_ship", color: "rgba(255,0,0," + config.UNOCHAOpacity + ")"},
  "--- Biological ---": {icon: "icon-logistics_ship", color: "rgba(255,0,0," + config.UNOCHAOpacity + ")"},
  "--- Geophysical ---": {icon: "icon-logistics_ship", color: "rgba(255,0,0," + config.UNOCHAOpacity + ")"},
  "--- Human Related ---": {icon: "icon-logistics_ship", color: "rgba(255,0,0," + config.UNOCHAOpacity + ")"},
  "--- Hydrometeorlogical ---": {icon: "icon-logistics_ship", color: "rgba(255,0,0," + config.UNOCHAOpacity + ")"},
  "--- Technological ---": {icon: "icon-logistics_ship", color: "rgba(255,0,0," + config.UNOCHAOpacity + ")"},
  "Biological": {icon: "icon-logistics_ship", color: "rgba(255,0,0," + config.UNOCHAOpacity + ")"},
  "Geophysical": {icon: "icon-logistics_ship", color: "rgba(255,0,0," + config.UNOCHAOpacity + ")"},
  "Human Related": {icon: "icon-logistics_ship", color: "rgba(255,0,0," + config.UNOCHAOpacity + ")"},
  "Hydrometeorological": {icon: "icon-logistics_ship", color: "rgba(255,0,0," + config.UNOCHAOpacity + ")"},
  "Technological": {icon: "icon-logistics_ship", color: "rgba(255,0,0," + config.UNOCHAOpacity + ")"}
