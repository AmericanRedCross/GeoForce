...
operation.Query = "SELECT " + settings.projectDetails.join(" ,") + " FROM sf_aggregated_gadm_project_counts, sf_project WHERE sf_aggregated_gadm_project_counts.sf_id = sf_project.sf_id AND guid{{gadm_level}} = {{guids}};";
