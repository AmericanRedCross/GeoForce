...
nonsensitiveSettings.displayViews = false;
...
nonsensitiveSettings.pg.noFlyList = ["att_0", "americanredcross_chapters", ];
...
//GADM
nonsensitiveSettings.dsColumns["gadm0"] = { geometry: "ST_AsGeoJSON(ST_Extent(geom)) as geom,", columns: "guid as stack_guid, id_0 as adm0_code, name_0 as adm0_name, ST_AsText(ST_Centroid(geom)) as centroid, 0 as level" };
nonsensitiveSettings.dsColumns["gadm1"] = { geometry: "ST_AsGeoJSON(ST_Extent(geom)) as geom,", columns: "guid as stack_guid, id_0 as adm0_code, name_0 as adm0_name, id_1 as adm1_code, name_1 as adm1_name, ST_AsText(ST_Centroid(geom)) as centroid, 1 as level" };
nonsensitiveSettings.dsColumns["gadm2"] = { geometry: "ST_AsGeoJSON(ST_Extent(geom)) as geom,", columns: "guid as stack_guid, id_0 as adm0_code, name_0 as adm0_name, id_1 as adm1_code, name_1 as adm1_name, id_2 as adm2_code, name_2 as adm2_name, ST_AsText(ST_Centroid(geom)) as centroid, 2 as level" };
nonsensitiveSettings.dsColumns["gadm3"] = { geometry: "ST_AsGeoJSON(ST_Extent(geom)) as geom,", columns: "guid as stack_guid, id_0 as adm0_code, name_0 as adm0_name, id_1 as adm1_code, name_1 as adm1_name, id_2 as adm2_code, name_2 as adm2_name, id_3 as adm3_code, name_3 as adm3_name, ST_AsText(ST_Centroid(geom)) as centroid, 3 as level" };
nonsensitiveSettings.dsColumns["gadm4"] = { geometry: "ST_AsGeoJSON(ST_Extent(geom)) as geom,", columns: "guid as stack_guid, id_0 as adm0_code, name_0 as adm0_name, id_1 as adm1_code, name_1 as adm1_name, id_2 as adm2_code, name_2 as adm2_name, id_3 as adm3_code, name_3 as adm3_name, id_4 as adm4_code, name_4 as adm4_name, ST_AsText(ST_Centroid(geom)) as centroid, 4 as level" };
nonsensitiveSettings.dsColumns["gadm5"] = { geometry: "ST_AsGeoJSON(ST_Extent(geom)) as geom,", columns: "guid as stack_guid, id_0 as adm0_code, name_0 as adm0_name, id_1 as adm1_code, name_1 as adm1_name, id_2 as adm2_code, name_2 as adm2_name, id_3 as adm3_code, name_3 as adm3_name, id_4 as adm4_code, name_4 as adm4_name, id_5 as adm5_code, name_5 as adm5_name, ST_AsText(ST_Centroid(geom)) as centroid, 5 as level" };

//settings for geonames API
nonsensitiveSettings.geonames = {};
nonsensitiveSettings.geonames.username = 'amcross';
