...
CREATE OR REPLACE VIEW vw_theme_projects_gadm AS 
 SELECT text_search.name, text_search.level, text_search.country, text_search.geom, text_search.fullname, text_search.stack_guid, count(text_search.id) as project_count
