...
-- create primary keys
ALTER TABLE gadm0_2014 ADD PRIMARY KEY (id_0);
ALTER TABLE gadm1_2014 ADD PRIMARY KEY (id_1);
ALTER TABLE gadm2_2014 ADD PRIMARY KEY (id_2);
ALTER TABLE gadm3_2014 ADD PRIMARY KEY (id_3);
ALTER TABLE gadm4_2014 ADD PRIMARY KEY (id_4);
ALTER TABLE gadm5_2014 ADD PRIMARY KEY (id_5);